...
`docs/forge-design-1.1.md` is the implementation contract.

## Documentation map

| File | What it is |
|---|---|
| [`docs/forge-design-1.1.md`](docs/forge-design-1.1.md) | v1 implementation contract (≈1400 lines) |
| [`docs/design-rationale.md`](docs/design-rationale.md) | Non-obvious tradeoffs preserved from the 0.1 → 1.0 design evolution |
...
[`docs/forge-design-1.1.md` §17](docs/forge-design-1.1.md#17-build-order-de-risked).
