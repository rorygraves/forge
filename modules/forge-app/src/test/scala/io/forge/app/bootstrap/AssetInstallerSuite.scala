...
class AssetInstallerSuite extends munit.FunSuite:
  ...
  private def allExpectedDestinations(paths: ForgePaths): Vector[os.Path] =
    Vector(
      ...
      paths.userSchemasDir / "repo-profile.json",
      paths.userSchemasDir / "failure-classifier.json",
      paths.userSchemasDir / "convention-deltas.json",
      ...
      paths.userPromptsDir / "repo-profile.claude.md",
      paths.userPromptsDir / "repo-profile.codex.md",
      paths.userPromptsDir / "failure-classifier.claude.md",
      paths.userPromptsDir / "failure-classifier.codex.md",
      paths.userPromptsDir / "learn-conventions.claude.md",
      paths.userPromptsDir / "learn-conventions.codex.md",
      paths.userPromptsDir / "specify.claude.md",
      paths.userPromptsDir / "specify.codex.md",
      paths.userPromptsDir / "implement.claude.md",
      paths.userPromptsDir / "implement.codex.md",
      paths.userPromptsDir / "fixup.claude.md",
      paths.userPromptsDir / "fixup.codex.md",
