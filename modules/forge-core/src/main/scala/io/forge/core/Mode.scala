...
/** Driver/reviewer pairing for a feature. v1 supports two modes; mid-feature switching is unsupported (§7, §1
  * non-goals).
  */
enum Mode:
...
/** Per-connector question delivery (§7.2/§7.3). Captured at connector construction; never changes mid-session.
  */
