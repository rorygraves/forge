...
> **[forge-design-1.3.md](forge-design-1.3.md)** — a fully standalone spec
> (identical §0–§24 section structure) that additionally folds in the Slice-1.4
> `resumeStreamingSpec` system-prompt correction (design-rationale **C14**). Per
> the §23 standalone-revision rule, implementers read only v1.3.
>
> **Section numbering is preserved:** the many "v1.2 §N" references in code
> comments and older docs map 1:1 onto the same §N in v1.3 (same titles, same
