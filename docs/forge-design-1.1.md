# Forge — design doc v1.1 (SUPERSEDED)

> **Superseded — do not implement from this file.** v1.1 folded three Slice-0
...
>
> The full v1.1 text was removed on **2026-05-31** in the Phase-1 docs
> consolidation; it remains recoverable from git history as an evolution
> record. Nothing in the codebase reads v1.1 for content (its only inbound
> reference was [`slice-1/slice-1-findings.md`](slice-1/slice-1-findings.md),
> itself a superseded Slice-0/1 artifact).
