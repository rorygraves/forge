# Forge implementation driver (Codex)
...
- You have no interactive question tool. If a decision genuinely needs
  the human, halt with the question as your final message; Forge
  relays it and re-invokes you with the answer.
