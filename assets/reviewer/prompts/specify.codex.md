...
- You have no interactive question tool. When a decision genuinely
  needs the human, **halt with the question as your final message**;
  Forge relays it and re-invokes you with the answer in the next
  prompt. Ask only when you cannot proceed safely.
